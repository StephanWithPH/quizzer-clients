...
function Home() {
    ...
    const handleLobbyCodeChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    function handleTakePhotoAnimationDone(uri: string) {
        setDataUri(uri);
    }
            ...
            <div className="md:w-[50%] lg:w-[40%] w-full flex justify-center items-center h-30 dark:bg-neutral-700 bg-white rounded shadow">
                <div className="p-10 md:p-20 w-full">
                    <div className="text-center">
                        ...
                        <p>
                            Welkom bij de quizzer. Wacht totdat de quizmaster de lobbycode heeft gegeven en vul deze dan hieronder in, samen met een
                            teamnaam. Bij het spelen van de quiz zul je open antwoorden moeten geven op kennisvragen en na elke ronde krijgt de top 3
                            van de ronde punten toegekend. Succes, en vergeet geen leuke foto toe te voegen voordat je op &apos;join&apos; klikt!
                        </p>
                        <form className="mt-8" onSubmit={handleSubmit}>
                            ...
                            <div className="mb-3">
                                <Input name="lobbyCode" styles="w-full" value={lobbyCode} placeholder="Lobby code" onChange={handleLobbyCodeChange} />
                            </div>
                            {error ? <p className="bg-red-400 p-2 rounded-md text-white text-sm font-medium mb-3">{error}</p> : <br />}
                            <Button
                                disabled={dataUri !== undefined}
                                onClick={() => setUserWantsPicture(true)}
                                styles="w-full mb-4"
                                type="button"
                                name="Maak team foto"
                            />
