...
export default function dashboardReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case 'SET_DASHBOARD_CATEGORIES':
      return { ...state, categories: [...action.payload.categories], totalCategoryCount: action.payload.total };
    ...
    case 'SET_DETAIL_QUIZ':
      return { ...state, detailQuiz: action.payload };
    default:
      return {
        ...state,
      };
