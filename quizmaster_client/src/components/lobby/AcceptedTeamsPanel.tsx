...
function AcceptedTeamsPanel() {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto h-full border-2 border-gray-200 dark:border-neutral-600 transition-all dark:text-white dark:bg-neutral-700 bg-white"
      >
