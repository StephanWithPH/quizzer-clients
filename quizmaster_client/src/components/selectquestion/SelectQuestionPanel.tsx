...
interface SelectQuestionPanelProps {
    questions: Question[];
}

function SelectQuestionPanel({ questions }: SelectQuestionPanelProps) {
        ...
        <div className="h-full flex flex-col overflow-hidden">
            ...
            justify-between items-center w-full px-4 py-2 border-b dark:border-neutral-400 border-gray-200"
                    >
                        ...
                        <span className="rounded-full bg-gradient-to-r from-indigo-500 via-violet-500 to-purple-500 text-white px-4 py-2 text-xs font-bold">
                            {question.category}
                        </span>
                    </button>
                ))}
