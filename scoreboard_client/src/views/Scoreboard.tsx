  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="grid grid-cols-12 flex-1 relative">
        <div
          className={`flex pt-5 relative flex-col gap-y-2 px-24 xl:pl-24 xl:pr-6 min-h-[90vh] 
        ${teams && teams.length > 0 ? "col-span-12 xl:col-span-11" : "col-span-12"}`}
        >
          <div className="flex justify-center items-center">
            <div className="flex flex-col gap-y-2">
              <div className="grid grid-cols-5 min-h-[4rem] justify-center h-full rounded-full overflow-hidden items-center">
                {askedQuestion ? (
                  <>
                    <div
                      className="font-bold col-span-5 lg:col-span-4 overflow-hidden h-full flex items-center
                  ...
                  <p className="text-xl w-full col-span-5 rounded-full bg-violet-500 text-white px-4 py-2.5">
                    {round ? (
                      "De ronde is gestart! Nog geen vraag gesteld."
                    ) : (
                      <>
                        Join via{" "}
